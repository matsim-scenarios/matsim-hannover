# The MATSim Open Hannover Scenario
...
This repository provides an open MATSim transport model for Hannover, provided by the [Transport Systems Planning and Transport Telematics group](https://www.vsp.tu-berlin.de) of [Technische Universität Berlin](https://www.tu.berlin/).
...
This scenario contains a 10pct sample of Hannover and its surrounding area; road capacities are accordingly reduced. The scenario is calibrated taking into consideration the traffic counts, modal split and mode-specific trip distance distributions.
...
Handling of large files within git is not without problems (git lfs files are not included in the zip download; we have to pay; ...).  In consequence, large files, both on the input and on the output side, reside at https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/hannover .
...
1. Navigate to de -> hannover -> choose version -> output. E.g.: (https://simwrapper.github.io/site/public/de/hannover/hannover-v1.0/output/).
1. Enjoy the dashboards and visualizations.

### Run VIA on output files

1. Get VIA from https://www.simunto.com/via/.  (There is a free license for a small number of agents; that will probably work but only display a small number of vehicles/agents.)
1. Go to https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios/countries/de/hannover/ .
...
1. Go to "Run the MATSim Hannover scenario" below.
...
1. Type `git clone https://github.com/matsim-scenarios/matsim-hannover.git` in the command line.

(Or use your IDE, e.g. Eclipse, IntelliJ, to clone the repository.)

This will result in a new `matsim-hannover` directory.  Memorize where you have put it.  You can move it, as a whole, to some other place.

### Update your local clone of the repository.

1. Go into the `matsim-hannover` directory.
1. Type `git pull`
...
----
## Run the MATSim Hannover scenario ...
...
1. Depending on the version of matsim-hannover you have selected, you might have to create the jar file yourself.
...
1. Run the JAVA class [RunHannoverScenario.java](src%2Fmain%2Fjava%2Forg%2Fmatsim%2Frun%2FRunHannoverScenario.java).
1. "Open" the output directory.  You can drag files into VIA as was already done above.
...
https://docs.google.com/document/d/1IA-UPFH66aQwt2NlHDQ5xuPWRlo4xZ3zZrW2jt2qfsk/edit?tab=t.0